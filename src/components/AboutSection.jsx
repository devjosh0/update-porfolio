    ...
    <section id="about" className="min-h-screen flex items-center justify-center px-8 py-20 bg-gray-100 dark:bg-gray-900">
      <div className="max-w-3xl text-center">
        ...
        <p className="text-gray-700 dark:text-gray-300 text-lg">
          I'm a passionate Software Test Engineer with over two years of hands-on experience in both manual and automated testing. I’m passionate about delivering high-quality software through meticulous testing strategies that ensure performance, reliability, and user satisfaction.
